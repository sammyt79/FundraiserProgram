...
/**
 * This class executes queries on the DonorDB database and provides the results
 * in arrays.
 */
public class DonorDBQuery {
     ...
     * Constructor
     */
    public DonorDBQuery(String query) {
    ...
    /**
     * The getColumNames method returns the column names.
     */
