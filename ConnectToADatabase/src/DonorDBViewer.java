...
/**
 * The DonorDBViewer class is a simple database viewer for the DonorDB database.
 */
public class DonorDBViewer extends JFrame {
     ...
     * Constructor
     */
    public DonorDBViewer() {
        // Set the window title.
        setTitle("DonorDB Viewer");
    ...
    /**
     * The buildQueryPanel method builds a panel to hold the text area that the
     * user will enter a query into.
     */
    private void buildQueryPanel() {
        ...
        // Add sample query
        queryTextArea.append("SELECT * FROM Donor");
    ...
    /**
     * The buildButtonPanel method builds a panel to hold the Submit and Exit
     * buttons.
     */
    ...
    /**
     * The SubmitButtonListener class is an action listener for the Submit
     * button.
     */
    private class SubmitButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (userStatement.trim().toUpperCase()
                    .startsWith("SELECT")) {
                // Create a DonorDBQuery object for the query.
                DonorDBQuery dbQuery
                        = new DonorDBQuery(userStatement);
